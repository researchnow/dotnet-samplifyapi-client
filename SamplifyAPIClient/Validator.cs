...
namespace Dynata.SamplifyAPIClient
{
    ...
    internal static class Validator
    {
        ...
        private static string errEntryUrlLength = String.Format("surveyURL cannot exceed {0} characters in length", MaxUrlLength);
        ...
        internal static void ValidateUrlLength(string url)
        {
            if (url != null && url.Length > MaxUrlLength)
            {
                throw new ValidationException(errEntryUrlLength);
            }
        }
